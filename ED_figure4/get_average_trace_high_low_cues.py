...
np.savez(os.path.join(dir, file_name), contra_high_cues=contra_high_cues, contra_low_cues=contra_low_cues, ipsi_high_cues=ipsi_high_cues, ipsi_low_cues=ipsi_low_cues, time_stamps=time_stamps)
