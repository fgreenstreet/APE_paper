...
mouse_ids =['SNL_photo16', 'SNL_photo17', 'SNL_photo18', 'SNL_photo21', 'SNL_photo22', 'SNL_photo26', 'SNL_photo57',
                'SNL_photo58', 'SNL_photo70', 'SNL_photo72'] #['SNL_photo16', 'SNL_photo17', 'SNL_photo18', 'SNL_photo21', 'SNL_photo22', 'SNL_photo26'] # ['SNL_photo28', 'SNL_photo30', 'SNL_photo31', 'SNL_photo32', 'SNL_photo33', 'SNL_photo34', 'SNL_photo35']
site = 'tail'
...
for index, experiment in experiments_to_process.iterrows():
    ...
    kernel_filename = save_filename + 'linear_regression_kernels_different_shifts_all_cues_matched_trials.p'#'linear_regression_kernels_different_shifts_not_cleaned.p'  #'linear_regression_kernels_different_shifts.p'
    inputs_X_filename = save_filename + 'linear_regression_different_shifts_X_all_cues_matched_trials.p'  #'linear_regression_different_shifts_X.p'
    inputs_y_filename = save_filename + 'linear_regression_different_shifts_y_all_cues_matched_trials.p' #'linear_regression_different_shifts_y.p'
