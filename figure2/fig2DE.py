import os
from set_global_params import reproduce_figures_path, processed_data_path, spreadsheet_path
...
pickle_folder = os.path.join(reproduce_figures_path, 'fig2')
spreadsheet_folder = os.path.join(spreadsheet_path, 'fig2')
...
# heatmaps require either repro data, or files generated by figure2/format_first_three_sessions_for_heatmap.py
...
# average traces require either repro data or files generated by figure2/per_mouse_average_traces.py
