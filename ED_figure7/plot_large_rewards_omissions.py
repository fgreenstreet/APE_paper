...
from set_global_params import fig4_plotting_colours, reproduce_figures_path, spreadsheet_path
...
for site in sites:
    ...
    summary_data = compare_peaks_across_trial_types(site_data, colour=fig4_plotting_colours[site][0])
